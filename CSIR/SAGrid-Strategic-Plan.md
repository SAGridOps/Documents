...
<!-- This is lifted directly from the JRU document -->
...
> improve **access** to, **efficiency** and **interoperability** of the resources <br> 
> provided by as many sites as possible,  <br>
> for as many user communities as possible <br>
...
[^VRC]: VRC : Virtual Research Communities

[^CHPC]: CHPC : The Centre for High-Performance Computing

[^SANREN]: SANREN : The South African National Research Network

[^DIRISA]: DIRISA : Data-Intensive Research Infrastructure for South Africa.
